...
<template>
  ...
  >
    <div class="relative">
      <img class="hidden dark:block" :width="size" :height="size" alt="NocoDB" src="~/assets/img/icons/pc-256x256.png" />
      <img class="dark:hidden" :width="size" :height="size" alt="NocoDB" src="~/assets/img/icons/pc-256x256.png" />
